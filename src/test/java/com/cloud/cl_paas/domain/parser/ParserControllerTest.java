...
public class ParserControllerTest {
	...
	public void setup() {
		...
		ReqMessageDto reqMessageDto = new ReqMessageDto(
			"Test message with email test@test.com, url http://test.com and phone 123-456-7890");
	...
	public void shouldReturnParsedWordsWhenValidRequest() throws Exception {
		...
		mockMvc.perform(get("/parser")
				...
				.content(
					"{\"message\":\"Test message with email test@test.com, url http://test.com and phone 123-456-7890\"}"))
